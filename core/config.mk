...
ifneq ($(PALLADIUM_BUILD),)
include vendor/palladium/config/BoardConfigPalladium.mk
endif
...
ifneq ($(PALLADIUM_BUILD),)
ifneq ($(wildcard device/palladium/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/palladium/sepolicy/common/sepolicy.mk)
endif
endif
