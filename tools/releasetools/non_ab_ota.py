...
""" % bcb_dev)
  ...
  palladiumversion = target_info.GetBuildProp("ro.palladium.build.version")
  androidver = target_info.GetBuildProp("ro.build.version.release")
  buildtype = target_info.GetBuildProp("ro.palladium.buildtype")
  buildid = target_info.GetBuildProp("ro.build.id")
  buildday = target_info.GetBuildProp("ro.palladium.build.date")
  ...
  script.Print("                                        ")
  script.Print("****************************************")
  script.Print(" ROM version      : %s"%(palladiumversion))
  script.Print("")
